...
"_bandage", "_morphine", "_epinephrine","_medkit",
"_oldrifle","_oldmag",
"_ruckmags","_ruckweapons",
"_bandage","_morphine","_epinephrine","_sfrifle","_sfrifleGL","_sfriflemag","_sfsnrifle","_sfsnmag","_sfmg","_sfmgmag","_sfpistol","_sfpistolmag", "_dmrifle", "_dmriflemag", "_aa", "_aamag", "_radio"];
...
//   _rifleGL = "ACE_SOC_M4A1_GL_Aim";
   ...
   _sfsnrifle = "SCAR_H_LNG_Sniper";
   _sfsnmag = "20rnd_762x51_B_SCAR";
   _sfmg = "M249_m145_EP1";
...
// The block of code below identifies equipment for the CDF faction.
   ...
   case "cdf":
   {
   _rifle = "ACE_AK103_PSO";
   _rifleGL = "ACE_AK103_GL_PSO";
   _rifleTL = "ACE_AK103_GL_PSO";
   _medicrifle = "AKS-74p PSO";
   _medicmag = "30Rnd_545x39_AK";
   _MG = "ACE_RPK74M_1P29";
   ...
   _spmag = "ACE_30Rnd_762x39_T_AK47";
...
// The block of code below identifies equipment for the ChDKZ faction.
   ...
   case "ins":
   {
   _rifle = "ACE_AK74M_PSO";
   _rifleGL = "ACE_AK74M_GL_PSO";
   _rifleTL = "ACE_AK74M_GL_PSO";
   _medicrifle = "ACE_AKS74P_PSO";
   _medicmag = "30Rnd_545x39_AK";
   _MG = "ACE_RPK74M_1P29";
   _riflemag = "30Rnd_545x39_AK";
