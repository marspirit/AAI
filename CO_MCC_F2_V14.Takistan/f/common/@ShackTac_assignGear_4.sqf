...
"_oldrifle","_oldmag",
"_ruckmags","_ruckweapons","_sfrifle","_sfrifleGL","_sfriflemag","_sfsnrifle","_sfsnmag","_sfmg","_sfmgmag","_sfpistol","_sfpistolmag","_sfrifleGLmag", "_dmrifle", "_dmriflemag"];
...
// LOADOUT: SF TEAM LEADER
   ...
   case "sfl":
   {
	  ...
	  [_unit,"ACE_IR_Strobe_Target",1] spawn f_addMagToRuck;
