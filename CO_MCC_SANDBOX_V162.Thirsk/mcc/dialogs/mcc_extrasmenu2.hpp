...
//zones
  ...
  class Zone_Number : RscComboBox {	idc = MCC_ZONE_NUMBERS;	style = ST_LEFT;colorText[] = { 1, 1, 1, 1 };colorSelect[] = { 1.0, 0.35, 0.3, 1 };	colorBackground[] = { 0, 0, 0, 0.6 };
									colorSelectBackground[] = { 0, 0, 0, 1 };font = "BitStream";sizeEx =0.028;	x = 0.42; y = 0.65;w = 0.06; h = 0.028;onLBSelChanged = "[0,3] execVM 'mcc\pop_menu\zones.sqf'";};
  class Zone_x : Zone_Number {idc = MCC_ZONE_X;y = 0.7;};
  class Zone_y : Zone_Number {idc = MCC_ZONE_Y;y = 0.75;};
...
//Evac
  ...
  class evacFastrope : evacHeliType {idc = FAST_ROPE;x = 0.25;y = 0.44;h = 0.024;};
//Jukebox
...
//EndMission
  class endMissionTitle : createTasks {x = 0.65-0.1;text = "End Mission:";};
//Markers
...
//Evac
  ...
  class evacFastropeTitle : evacTitle {x = 0.16;text = "Approach:";};
...
//Tasks Buttons
  ...
  //EndMission
  class endMissionSucess : RscButton {idc = -1;x = 0.67;y = 0.272;colorText[] = {0,1,0,1};text = "Succeeded";action = "if (mcc_missionmaker == (name player)) then {nul=[5] execVM 'mcc\pop_menu\tasks_req.sqf';} else {player globalchat 'Access Denied'};";};
  class endMissionFail : RscButton {idc = -1;x = 0.76;y = 0.272;colorText[] = {1,0,0,1};text = "Failed";action = "if (mcc_missionmaker == (name player)) then {nul=[6] execVM 'mcc\pop_menu\tasks_req.sqf';} else {player globalchat 'Access Denied'};";};
  //Markers Buttons
