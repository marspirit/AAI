...
private ["_ied","_side","_size","_rad","_time","_group","_trg","_targ","_eod","_wait","_wait2","_armed","_near","_nrsd","_detect","_tmo","_count","_sel","_luck","_pos","_tim","_engi", "_enemy"];
_ied  = _this select 0;
			...
			for [{_x=0},{_x<_count},{_x=_x+1}] do
				...
				{if(_enemy isKindOf _x && _check) then
					...
					while {alive _ied} do
						...
						_ied setBehaviour "CARELESS";
						_ied setunitpos "UP";
						_ied move getpos _enemy;
						sleep 1;
