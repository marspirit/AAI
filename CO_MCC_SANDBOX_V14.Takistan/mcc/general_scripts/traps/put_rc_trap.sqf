...
private ["_pos", "_trapdistance", "_trapsnumber", "_iedside", "_trapvolume", "_trapkind", "_eib_marker", "_rcside", "_roadlist", "_rc", "_Offset", "_validpos",
"_z", "_x1", "_x2", "_y1", "_y2", "_pi", "_angle", "_midpoint", "_distance", "_trigger", "_ied"]; 
...
if (count _roadlist>0) then 
		{
			...
			_trigger setTriggerArea [_distance, 10, _angle, true];
