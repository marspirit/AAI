...
//Mobile Spawn
 ...
 //Coin
 class coinVehicle : Zone_Number {idc = COIN_VEHICLE;x = 0.45;y = 0.08;sizeEx = 0.03;w = 0.09; h = 0.03;};
 class coinSide : coinVehicle {idc = COIN_SIDE;y = 0.12;};
 class coinFunds : coinVehicle {idc = COIN_FUNDS;y = 0.16;};
//-------------------------------------------Titels-------------------------------------------
//Zones
...
//Coin
  ...
  class coinSideTittle : coinVehicleTypeTitle {y = 0.11;text = "Radius:";};
  class coinFundsTittle : coinVehicleTypeTitle {y = 0.15;text = "Funds:";};
//----------------------------------------TextBox---------------------------------------------
...
//coin
  class coinButton : RscButton {idc = -1;x = 0.4; y = 0.2;w = 0.1;h = 0.06;size = 0.02;sizeEx = 0.03;text = "Create";onButtonClick = "if (mcc_missionmaker == (name player)) then {nul=[] execVM 'mcc\general_scripts\coin\coin_req.sqf';} else {player globalchat 'Access Denied'};";};
   };
