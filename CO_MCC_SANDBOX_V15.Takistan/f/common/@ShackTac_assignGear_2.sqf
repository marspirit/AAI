...
"_bandage","_morphine","_epinephrine","_medkit","_sfrifle","_sfrifleGL","_sfriflemag","_sfsnrifle","_sfsnmag","_sfmg","_sfmgmag","_sfpistol","_sfpistolmag", "_dmrifle", "_dmriflemag", "_aa", "_aamag", "_radio"];
...
// EQUIPMENT: TAKISTAN ARMY
// The block of code below identifies equipment for the Takistan Army faction.
...
// EQUIPMENT: US ARMY
// The block of code below identifies equipment for the US Army faction.
...
// The block of code below identifies equipment for the CDF faction.
   ...
   _rifleGLmag = "ACE_30Rnd_762x39_T_AK47";
   _GLmag = "1Rnd_HE_GP25";
   _MGmag = "75Rnd_545x39_RPK";
   _grenade = "HandGrenade_East";
   _at = "RPG18";
   ...
   _snrifle = "SVD_CAMO";
   _snmag = "10Rnd_762x54_SVD";
   _sprifle = "ACE_AK103_PSO";
   _spmag = "30Rnd_545x39_AK";
   
   _dmrifle = "ACE_AK103_PSO";
   _dmriflemag = "ACE_30Rnd_762x39_T_AK47";
...
// LOADOUT: PLATOON COMMANDER
   ...
   case "pltco":
   {
      ...
      {_unit addmagazine _pistolmag} foreach [1,2,3,4,5,6,7,8];
...
// LOADOUT: PLATOON SGT.
   ...
   case "pltsgt":
   {
      ...
      {_unit addmagazine _GLmag} foreach [1,2,3,4,5,6,7,8];
      {_unit addmagazine _bandage} foreach [1,2];
      {_unit addmagazine _grenade} foreach [1,2];
      {_unit addmagazine _smokegrenade} foreach [1,2];
      ...
      [_unit,_smokered,4] spawn f_addMagToRuck;
...
// LOADOUT: PLATOON MEDIC
   ...
   case "pltm":
   {
      removeallweapons _unit;
	  removeBackpack _unit;
      {_unit addmagazine _medicmag} foreach [1,2,3,4,5,6,7];
      ...
      {_unit addmagazine _morphine;} foreach [1,2,3,4];
      {_unit addmagazine _epinephrine;} foreach [1,2,3,4];
	  {_unit addmagazine _medkit;} foreach [1,2,3];
      _unit addweapon "ACE_Map_Tools";
	  _unit addweapon "ACE_ParachuteRoundPack";
...
// LOADOUT: SQUAD LEADER
   ...
   case "sl":
   {
      ...
      [_unit,_smokered,6] spawn f_addMagToRuck;
	  [_unit,"Binocular",1] spawn f_addWepToRuck;
...
// LOADOUT: MEDIUM MG ASSISTANT GUNNER
   ...
   case "mmgag":
   {
	  ...
	  [_unit,"ACE_Rangefinder_OD",1] spawn f_addWepToRuck;
...
// LOADOUT: SF TEAM LEADER
   ...
   case "sfl":
   {
      ...
      [_unit,_GLmag,8] spawn f_addMagToRuck;
      [_unit,_smokegrenade,2] spawn f_addMagToRuck;
      [_unit,_smokered,6] spawn f_addMagToRuck;
...
// LOADOUT: SF Radioman
   ...
   case "sfg":
   {
	  ...
	  [_unit,"IR_Strobe_Marker",1] spawn f_addMagToRuck;
	  [_unit,"Laserdesignator",1] spawn f_addWepToRuck;
   ...
   case "sfhg":
   {
      switch (_faction) do
      {
		case "bis_tk":
		{
			...
			{_unit addmagazine _sfpistolmag;} foreach [1,2,3,4,5,6,7,8];
			{_unit addmagazine _bandage} foreach [1,2];
