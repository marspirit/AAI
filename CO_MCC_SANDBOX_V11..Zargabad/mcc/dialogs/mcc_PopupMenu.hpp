...
//Enviormet Settings
	...
	class weatherTitle : monthTitle {idc = -1;x = 0;y = 0.7-0.01;text = "Weather:";};
...
//Enviormet Settings
  ...
  class set_weat : set_time {x = 0+ 0.18; y =0.7 ;w = 0.07; h = 0.0422876;size = 0.02;sizeEx = 0.02821;text = "set";onButtonClick = "if (mcc_missionmaker == (name player)) then {[2] execVM 'mcc\Pop_menu\mission_settings.sqf'} else {player globalchat 'Access Denied'};";};
//RTE 
