...
class ExtrasDialog {
 ...
 class supportFrame : LHDFrame {moving = true;  y = 0.44;w = 0.345; h = 0.17;}; 
 class artilleryFrame : LHDFrame {moving = true;  y = 0.61;w = 0.345; h = 0.23;}; 
 ...
 //========================================= Controls========================================
  ...
  //Support
  class paratroops : HVT {idc = SUPPORT_PARATROOPS;x = 0.15; y = 0.49;}; 
  class hostages : paratroops {idc = SUPPORT_HOSTAGES; y = 0.49+0.03;}; 
  class artySite : paratroops {idc = SUPPORT_ARTYSITE; y = 0.49+0.06;}; 
  class uav : paratroops {idc = SUPPORT_UAV; y = 0.49+0.09;}; 
  class artyType : paratroops {idc = SUPPORT_ARTY_TYPE;x = 0.01; y = 0.51+0.18;}; 
...
//Zones
  ...
  //Support
  class supportTitle : IedTitle {x = 0.01;y = 0.45;colorText[] = {1,0,0};text = "Support:";};
  class paratroopsTitle : supportTitle {y = 0.48;colorText[] = {1,1,1};text = "Paratroops:";};
  class hostageTitle : paratroopsTitle {y = 0.48+0.03;text = "Hostage:";};
  class artySiteTitle : paratroopsTitle {y = 0.48+0.06;text = "ArtySite:";};
  class uavTitle : paratroopsTitle {y = 0.48+0.09;text = "UAV/ULB:";};
  class artilleryTitle : paratroopsTitle {x = 0.01; y = 0.5+0.12;colorText[] = {0,0,1};text = "Artillery:";};
  class artilleryTypeTitle : paratroopsTitle {x = 0.01; y = 0.5+0.15;text = "Type:";};
  class artillerySpreadTitle : paratroopsTitle {x = 0.01+0.09; y = 0.5+0.15;text = "Spread:";};
  class artilleryNumberTitle : paratroopsTitle {x = 0.01+0.18; y = 0.5+0.15;text = "Number:";};  
...
//Bottom Buttons
  ...
  class Extras : Close_dialog {x = 0.01;y=0.4;w = 0.33;text = "Main Menu";onButtonClick = "closeDialog 0;[] execVM 'mcc\Pop_menu\mcc_ActivatePopupMenuViaAction.sqf'";};
  //LHD spawn positions
  ...
  //Support
  class paratroopsSpawn : RscGUIShortcutButton {idc = -1;colorDisabled[] = {1, 0.4, 0.3, 0.8};x = 0.25; y = 0.49;w = 0.07;h = 0.04;size = 0.025;sizeEx = 0.028;text = "Spawn";onButtonClick = "[16] execVM 'mcc\pop_menu\spawn_group.sqf'";};
  class hostageSpawn : paratroopsSpawn {y = 0.49+0.03;text = "Spawn";onButtonClick = "nul=[3] execVM 'mcc\general_scripts\hostages\hostage_request.sqf'";};
  class artySiteSpawn : paratroopsSpawn {x = 0.25;y = 0.49+0.06;text = "Spawn";onButtonClick = "nul=[3] execVM 'mcc\general_scripts\arty_site\arty_site_request.sqf'";};
  class uavSpawn : paratroopsSpawn {y = 0.49+0.09;text = "Spawn";onButtonClick = "nul=[3] execVM 'mcc\general_scripts\uav\uav_request.sqf';";};
  class artySpawn : paratroopsSpawn {x = 0.28;y = 0.49+0.2;text = "Spawn";onButtonClick = "nul= execVM 'mcc\general_scripts\artillery\artillery_request.sqf';";};
  };
