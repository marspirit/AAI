...
class Respawn_button_4 
{
	...
	controlsBackground[] = {};
		...
		{	
			...
			idc = 1;
			text = "RESPAWN 1";
			action = "titletext ['','BLACK FADED', 1]; [1,player] execVM ""f\revive\respawn_at_base.sqf""";
		};
		...
		class Respawn_2 : NORRNRscNavButton
		{
			...
			idc = 2;
			text = "RESPAWN 2";
			action = "titletext ['','BLACK FADED', 1]; [2,player] execVM ""f\revive\respawn_at_base.sqf""";
		};
		...
		{	
			...
			idc = 3;
			text = "RESPAWN 3";
			action = "titletext ['','BLACK FADED', 1]; [3,player] execVM ""f\revive\respawn_at_base.sqf""";
		};
		...
		class Respawn_4	: NORRNRscNavButton
		{
			...
			idc = 4;
			text = "RESPAWN 4";
			action = "titletext ['','BLACK FADED', 1]; [4,player] execVM ""f\revive\respawn_at_base.sqf""";
		};
};