...
[[evac],["Launch",10]] call CBA_fnc_globalSay;
...
[[evac], ["going_down",10]] call CBA_fnc_globalSay;
};
...
if (_landing) then
{
   ...
   _heli setVariable ["mando_heliroute", "waiting"];
	[-2, {evac globalChat "Golf 1 touchdown"}] call CBA_fnc_globalExecute;
...
else
{
	...
	[-2, {evac globalChat "Golf 1 in position, clear for fastroping"}] call CBA_fnc_globalExecute;
