...
private [
"_faction","_rifle","_rifleGL","_rifleTL","_rifleOP","_MG","_pistol","_riflemag","_rifleGLmag",
...
// LOADOUT: PLATOON COMMANDER
   ...
   case "pltco":
   {
      ...
      if (_faction != "gue") then {_unit addweapon "NVGoggles"};    
...
// LOADOUT: PLATOON HQ SECTION RIFLEMAN
   ...
   case "pltr":
   {
      ...
      if (_faction != "gue") then {_unit addweapon _rucksack;
...
// LOADOUT: SQUAD LEADER
   ...
   case "sl":
   {
      removeallweapons _unit;
	  removeBackpack _unit;
	  if (_faction == "gue") then {_unit addweapon "M79_EP1";_success = [_unit, "M79_EP1"] call ACE_fnc_PutWeaponOnBack;};
      {_unit addmagazine _rifleGLmag} foreach [1,2,3,4,5,6,7,8];
      {_unit addmagazine _GLmag} foreach [1,2,3,4];
      {_unit addmagazine _bandage} foreach [1,2];
      {_unit addmagazine _grenade} foreach [1,2];
      ...
      _unit addweapon "Binocular";
      _unit addweapon "ACE_Map_Tools";
	  _unit addweapon "Kostey_notebook";
