...
class ExtrasDialog {
 ...
 //========================================= Controls========================================
  ...
  class Zone_Number : RscComboBox {	idc = MCC_ZONE_NUMBERS;	style = ST_LEFT;colorText[] = { 1, 1, 1, 1 };colorSelect[] = { 1.0, 0.35, 0.3, 1 };	colorBackground[] = { 0, 0, 0, 0.6 };
									colorSelectBackground[] = { 0, 0, 0, 1 };font = "BitStream";sizeEx =0.028;	x = 0.42; y = 0.65;w = 0.06; h = 0.028;onLBSelChanged = "[0,2] execVM 'mcc\pop_menu\zones.sqf'";};
  ...
  class typeIEDSpawn : RscButton {idc = -1;x = 0.61; y = 0.24;w = 0.11;h = 0.025;colorText[] = {0,0,1,1}; text = "Create IED"; onButtonClick = "nul=[0] execVM 'mcc\general_scripts\traps\trap_request.sqf';";};
  class typeIEDSpawnGroup : RscButton {idc = -1;x = 0.74; y = 0.24;w = 0.11;h = 0.025;colorText[] = {0,0,1,1}; text = "Create Ambush";onButtonClick = "nul=[1] execVM 'mcc\general_scripts\traps\trap_request.sqf';";};
  class typeIEDRteSave : RscButton {idc = -1;x = 0.61; y = 0.27;w = 0.24;h = 0.025;colorText[] = {0,0,1,1}; text = "Save armed civilian to clipboard";onButtonClick = "nul=[2] execVM 'mcc\general_scripts\traps\trap_request.sqf';";};
...
//Zones
  ...
  class airDropTypeTitle : uavTitle {y = 0.46+0.1;w = 0.4;text = "Class:					Type:					Queue:";};
...
//Bottom Buttons
	...
	class Safe : Close_dialog {x = 0.01;w = 0.16;text = "Safe";onButtonClick = "copyToClipboard mcc_safe;hint 'SAVED to Clipboard! Now you can paste this code where you like to save it. Simple copy it all back in clipboard (ctrl-c) and press load to rebuild your mission.';";};
	class Load : Close_dialog {x = 0.17;w = 0.16;text = "Load";onButtonClick = "mcc_safe = CopyFromClipboard;mcc_load='mcc_isloading=true;' + mcc_safe + ';mcc_isloading=false;';[] spawn compile mcc_load;";};
