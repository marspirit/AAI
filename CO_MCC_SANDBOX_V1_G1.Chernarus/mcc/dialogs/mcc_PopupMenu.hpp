...
#define PUM3_dlg_x 0.015
#define PUM3_dlg_y 0.32
...
class PUM3_PopupMenuDialog {
  ...
  //---------------------------------------------
  //background
 class MCC_Title : RscText {x = 0.02; y = 0.01;w = 3; colorBackground[] = { 1, 1, 1, 0 };text = "MCC Sandbox V1.0 redone by Shay_gman";};
 class MCC_Bckgrnd : RscPicture {idc = -1; moving = true; x = 0.0; y = 0.0; w = 1.5; h = 1.5; text = "\ca\ui\data\igui_background_diary_ca.paa";};
 class MCC_logo : RscPicture {idc = -1; moving = true; x = 0.005; y = 0.04; w = 0.34; h = 0.28; text = "mcc\pop_menu\mcc1.paa";};
 class MCC_mapBackground : RscText {idc = -1; moving = true; colorBackground[] = { 1, 1, 1, 1}; colorText[] = { 1, 1, 1, 0}; x = 0.555; y = 0.44;	w = 0.5; h = 0.4; text = "";};
 class MCC_SpawnSettingsBckgrnd : RscText {idc = -1;moving = true;colorBackground[] = { 0, 0, 0, 0.6 };colorText[] = { 1, 1, 1, 0 };x = 0.71; y = 0.31;w = 0.35; h = 0.12;text = "";};
 ...
 class toolsBackground : MCC_SpawnSettingsBckgrnd {moving = true; x = 0.675; y = 0.04;w = 0.4; h = 0.07;};
 ...
 class CSBackground : MCC_SpawnSettingsBckgrnd {moving = true; x = 0.005; y = 0.44;w = 0.345; h = 0.4;};
  ...
  //--------------------------------------------- Controls- special-------------------------------------------
  class MCC_map : RscMapControl {idc = -1; moving = true; colorBackground[] = { 0, 0, 0, 1}; colorText[] = { 1, 1, 1, 0}; x = 0.555; y = 0.44; w = 0.5; h = 0.4;text = "";};
  //=========================================ComboBox===================================================
...
//mission settings
	class set_month : unit_Infantry {idc = SET_MONTH;x = 0.07;y = 0.8;};
	class set_hour : set_month {idc = SET_HOUR;x = 0.07+0.12;};
	class set_weather : set_month {idc = SET_WEATHER;x = 0.09;y = 0.75;};
//CS settings
  ...
  class factionTitle : Zone_NumberTitle {x = 0.45-0.1;y = 0.05;text = "Faction:";};
	class GroupTitle : Zone_NumberTitle {x = 0.45-0.1;y = 0.15;text = "Group:";};
	...
	class UnitTitle : Zone_NumberTitle {x = 0.45-0.1;y = 0.25;text = "Unit:";};
	...
	class objectTitle : Zone_NumberTitle {x = 0.45-0.1;y = 0.35;text = "Object:";};
	...
	class startLocations : Zone_NumberTitle {x = 0.37;y = 0.45;colorText[] = { 1,1,1, 1 };text = "Start Locations:";};
	class zoneTitle : SpawnTitle {x = 0.39;y = 0.6;colorText[] = { 1,1,1, 1 };text = "Zones:";};
	class monthTitle : zoneTitle {idc =-1;x = 0;y = 0.8-0.01;colorText[] = { 1,1,1, 1 };text = "Month:";};
	class hourTitle : monthTitle {x = 0+0.14;text = "Hour:";};
	class weatherTitle : monthTitle {idc = -1;x = 0;y = 0.75-0.01;text = "Weather:";};
	class environmentSetTitle : monthTitle {idc = -1;x = 0.05;y = 0.7-0.01;text = "Environment Settings:";};
	class grassTitle : monthTitle {y = 0.5-0.01;text = "Grass Density:";};
	class viewTitle : monthTitle {y = 0.55-0.01;text = "View Distance:";};
	class CSTitle : startLocations {x = 0;text = "Client Side Settings:";};
			
		
  //--------------------------------Buttons----------------------------------------------------------------------------------
  class Zone_set : RscGUIShortcutButton {idc = MCC_SET_ZONE;colorDisabled[] = {1, 0.4, 0.3, 0.8};x = 0.35; y = 0.8;	text = "Update Zone";onButtonClick = "[1] execVM 'mcc\pop_menu\zones.sqf'";};
  ...
  class Refresh_dialog : RscGUIShortcutButton {idc = -1;colorDisabled[] = {1, 0.4, 0.3, 0.8};x = 0.7; y = 0.84;text = "Refresh";onButtonClick = "closeDialog 0;[] execVM 'mcc\Pop_menu\mcc_ActivatePopupMenuViaAction.sqf'";};
  class Update_Faction : RscGUIShortcutButton {idc = -1;colorDisabled[] = {1, 0.4, 0.3, 0.8};x = 0.56; y = 0.05;w = 0.105825; h = 0.0422876;size = 0.02821;sizeEx = 0.02821;text = "Update";onButtonClick = "[] execVM 'mcc\pop_menu\faction.sqf'"};
  ...
  class teleport : RscButton {x = 0.56 + 0.32;y = 0.05;w = 0.12;colorText[] = {1,1,1,1};text = "Teleport";onButtonClick = "if (mcc_missionmaker == (name player)) then {hint 'Click on the map';onMapSingleClick 'vehicle player setPos _pos; onMapSingleClick '''';true;'} else {player globalchat 'Access Denied'};"};
   class Start_west : RscButton {idc = START_WEST;x = 0.35;y = 0.5;colorText[] = {0,0,1,1};text = "Start West";action = "if (mcc_missionmaker == (name player)) then {nul=[3] execVM 'mcc\general_scripts\mcc_start_location_west.sqf';} else {player globalchat 'Access Denied'};"};
  class Start_east : Start_west {idc = START_EAST;x = 0.35+0.1;y = 0.5;colorText[] = {1,0,0,1};text = "Start East";action = "if (mcc_missionmaker == (name player)) then {nul=[3] execVM 'mcc\general_scripts\mcc_start_location_east.sqf';} else {player globalchat 'Access Denied'};"};
  class Start_guer : Start_west {idc = START_GUE;x = 0.35;y = 0.5+0.03;colorText[] = {0,1,0,1};text = "Start Guer";action = "if (mcc_missionmaker == (name player)) then {nul=[3] execVM 'mcc\general_scripts\mcc_start_location_guer.sqf';} else {player globalchat 'Access Denied'};"};
  ...
  class Disable_Respawn : Start_west {idc = DISABLE_RESPAWN;x = 0.37;y = 0.5+0.07;w = 0.15;colorText[] = {1,1,0,1};text = "Disable Respawn";action = "if (mcc_missionmaker == (name player)) then { MCC_TRAINING = FALSE;publicVariable ""MCC_TRAINING"";hint ""Mission started, respawn is off"";ctrlEnable [DISABLE_RESPAWN,false];enable_respawn=false;closeDialog 0;[] execVM 'mcc\Pop_menu\mcc_ActivatePopupMenuViaAction.sqf'} else {player globalchat 'Access Denied'};"};
  class set_time : RscGUIShortcutButton {idc = -1;colorDisabled[] = {1, 0.4, 0.3, 0.8};x = 0+ 0.28; y =0.8 ;w = 0.07; h = 0.0422876;size = 0.02;sizeEx = 0.02821;text = "set";onButtonClick = "if (mcc_missionmaker == (name player)) then {[1] execVM 'mcc\Pop_menu\mission_settings.sqf'} else {player globalchat 'Access Denied'};"};
  class set_weat : set_time {x = 0+ 0.18; y =0.75 ;w = 0.07; h = 0.0422876;size = 0.02;sizeEx = 0.02821;text = "set";onButtonClick = "if (mcc_missionmaker == (name player)) then {[2] execVM 'mcc\Pop_menu\mission_settings.sqf'} else {player globalchat 'Access Denied'};"};
