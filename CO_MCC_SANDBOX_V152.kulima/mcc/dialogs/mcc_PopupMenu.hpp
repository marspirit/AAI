...
//Units
	class UnitTitle : Zone_NumberTitle {x = 0.45-0.1;y = 0.23;colorText[] = {0,1,1,1};text = "Unit:";};
		...
		class UnitSpawn : GroupSpawn {idc = -1;colorDisabled[] = {1, 0.4, 0.3, 0.8};x = 0.77;y = 0.22;w = 0.1; h = 0.05;size = 0.025;sizeEx = 0.03;text = "Spawn";onButtonClick = "if (mcc_missionmaker == (name player)) then {[1,false] execVM 'mcc\pop_menu\spawn_group.sqf'} else {player globalchat 'Access Denied'};";};
		class UnitSpawn3d : GroupSpawn {idc = -1;colorDisabled[] = {1, 0.4, 0.3, 0.8};x = 0.77;y = 0.265;w = 0.1; h = 0.05;size = 0.025;sizeEx = 0.03;text = "Spawn3D";onButtonClick = "if (mcc_missionmaker == (name player)) then {[1,true] execVM 'mcc\pop_menu\spawn_group.sqf'} else {player globalchat 'Access Denied'};";};
