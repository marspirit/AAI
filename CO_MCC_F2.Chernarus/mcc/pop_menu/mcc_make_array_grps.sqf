								   ...
								   if (isClass(_cfgclasstype)) then
									{
										...
										if ((getText(_cfgclasstype >> "faction"))== _faction) then 
										{
											...
											_grp_array set[_indexar,[["Item", _cfgname],["Action", format ["mcc_spawntype=""GROUP"";mcc_classtype=""%1"";mcc_spawnname=""%2"";mcc_spawnfaction=""%3"";nul=[4] execVM 'mcc\general_scripts\mcc_SpawnStuff.sqf';mcc_spawndisplayname=""%5"";",_classtype,_cfgclass,_cfgentry,_cfgname]]  ]];									
											_indexar = _indexar + 1;
