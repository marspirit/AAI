...
"_oldrifle","_oldmag",
"_ruckmags","_ruckweapons","_sfrifle","_sfrifleGL","_sfriflemag","_sfsnrifle","_sfsnmag","_sfmg","_sfmgmag","_sfpistol","_sfpistolmag","_sfrifleGLmag"];
...
// LOADOUT: SF MG
   ...
   case "sfhg":
   {
	  ...
	  [_unit,"8Rnd_B_Beneli_74Slug",10] spawn f_addMagToRuck;	
...
// LOADOUT: SF Grenadir
   ...
   case "sfg":
   {
      ...
      [_unit,_smokegreen,1] spawn f_addMagToRuck;
      [_unit,"ACE_M7A3",2] spawn f_addMagToRuck;
	  [_unit,"ACE_IRStrobe",1] spawn f_addMagToRuck;
