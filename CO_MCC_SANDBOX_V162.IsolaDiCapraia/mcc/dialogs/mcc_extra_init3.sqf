...
//------------------------------POPZ---------------------------------------------------------------------------------------------------------------------
_comboBox = _mccdialog displayCtrl POPZ_ACTION; //fill combobox POPZ actions
	lbClear _comboBox;
	{
		_displayname = _x;
		_comboBox lbAdd _displayname;
...
_comboBox = _mccdialog displayCtrl POPZ_INTANSE;		//fill combobox class to delete
	lbClear _comboBox;
	{
		_displayname = _x;
		_comboBox lbAdd _displayname;
...
//player sidechat format["mcc_extra_init.sqf"]; // debug