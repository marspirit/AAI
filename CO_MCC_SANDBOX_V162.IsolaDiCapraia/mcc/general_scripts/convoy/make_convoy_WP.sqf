...
if !mcc_isloading then 
	...
	if (mcc_capture_state) then
		...
		mcc_capture_var = mcc_capture_var + FORMAT ["
			...
			hint "Convoy placed";
			["place_convoy", [convoy_car1 select 0, convoy_car2 select 0, convoy_car3 select 0, convoy_car4 select 0, convoy_car5 select 0, _point1, _point2, _point3, _point4, _point5, [mcc_sidename] select 0, vip select 0, vipCar select 0]] call CBA_fnc_globalEvent;
