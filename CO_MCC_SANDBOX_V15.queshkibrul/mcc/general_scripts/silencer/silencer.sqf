...
private ["_caller", "_weapon", "_mag", "_sdmag", "_magazines", "_weapons", "_items", "_stance", "_weaponnew","_success"];
...
switch (_weapon) do 
	...
	if (_success) then
		...
		switch (_stance) do {
						case "stand":
						{
						_caller playMove "WeaponMagazineReloadStand";
						};
						case "kneel":
						{
						_caller playMove "WeaponMagazineReloadKneel";
						};
						case "prone":
						{
						_caller playMove "WeaponMagazineReloadProne";
						};
						default
						{
