...
private [
"_faction","_rifle","_rifleGL","_rifleTL","_rifleOP","_MG","_pistol","_riflemag",
...
// LOADOUT: PLATOON COMMANDER
   ...
   case "pltco":
   {
      removeallweapons _unit; removeBackpack _unit; 
...
// LOADOUT: MEDIUM MG ASSISTANT GUNNER
   ...
   case "mmgag":
   {
      ...
      [_unit,"ACE_Battery_Rangefinder",4] spawn f_addMagToRuck; 
