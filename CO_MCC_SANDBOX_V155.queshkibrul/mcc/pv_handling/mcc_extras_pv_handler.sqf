...
if (isServer) then
{
	...
	["simpleSpawn", {[(_this select 0), (_this select 1), (_this select 2), (_this select 3), (_this select 4), (_this select 5), (_this select 6)] execvm "mcc\pop_menu\simple_spawn.sqf";}] call CBA_fnc_addEventHandler;
