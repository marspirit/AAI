...
cameraman setposasl [(mPos select 0)+0.6, (mPos select 1)-6, 5001];



_light = "#lightpoint" createVehicleLocal [(mPos select 0), (mPos select 1), 5003.3];
_light setposasl [(mPos select 0), (mPos select 1)+1, 5003.3];
...
sleep 15;
sleep random 30;
_light setLightColor[0.00, 0.5, 0.00];
