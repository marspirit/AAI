...
//Jukebox
  class jukeBoxTrack : evacHeliType {idc = MUSIC_TRACK;y = 0.61;w = 0.25;};
  class jukeboxVolume : RscSlider{idc = MUSIC_VOLUME;style = "0x400  + 0x10";x = 0.07;y = 0.645;w = 0.13;h = 0.025;color[] = {1,1,1,1};coloractive[] = {0,1,0,1};onSliderPosChanged =  "nul=[4] execVM 'mcc\general_scripts\jukebox\jukebox.sqf';";};
  class jukeBoxActivate : evacHeliType {idc = MUSIC_ACTIVATE;x = 0.09;y = 0.67;};
  class jukeBoxCond : jukeBoxActivate {idc = MUSIC_COND;x = 0.24;};
  class jukeBoxZone : jukeBoxActivate {idc = MUSIC_ZONE;y = 0.7;};
...
//Juke Box
  ...
  class jukeBoxTrackTitle : markers {y = 0.6;colorText[] = {1,1,1,1};text = "Track:";};
  class jukeBoxVolumeTitle : jukeBoxTrackTitle {y = 0.63;text = "Volume:";};
  class jukeBoxActivateTitle : jukeBoxTrackTitle {y = 0.66;text = "Activate:";};
  class jukeBoxCondTitle : jukeBoxActivateTitle {x = 0.18;text = "Cond:";};
  class jukeBoxZoneTitle : jukeBoxActivateTitle {y = 0.69;text = "Zone:";};
...
//Tasks Buttons
  ...
  //Jukebox
  class jukeboxBack : RscButton {idc = -1;x = 0.21;y = 0.64;w = 0.02;colorText[] = {1,1,1,1};text = "<<";action = "if (mcc_missionmaker == (name player)) then {nul=[0] execVM 'mcc\general_scripts\jukebox\jukebox.sqf';} else {player globalchat 'Access Denied'};";};
  class jukeboxPlay : RscButton {idc = -1;x = 0.24;y = 0.64;w = 0.02;colorText[] = {0,1,0,1};text = ">";action = "if (mcc_missionmaker == (name player)) then {nul=[1] execVM 'mcc\general_scripts\jukebox\jukebox.sqf';} else {player globalchat 'Access Denied'};";};
  class jukeboxForward : RscButton {idc = -1;x = 0.27;y = 0.64;w = 0.02;colorText[] = {1,1,1,1};text = ">>";action = "if (mcc_missionmaker == (name player)) then {nul=[2] execVM 'mcc\general_scripts\jukebox\jukebox.sqf';} else {player globalchat 'Access Denied'};";};
  class jukeboxStop : RscButton {idc = -1;x = 0.3;y = 0.64;w = 0.02;colorText[] = {1,0,0,1};text = "+";action = "if (mcc_missionmaker == (name player)) then {nul=[3] execVM 'mcc\general_scripts\jukebox\jukebox.sqf';} else {player globalchat 'Access Denied'};";};
  class jukeboxLinkZone : RscButton {idc = -1;x = 0.2;y = 0.7;w = 0.06;colorText[] = {1,0,0,1};text = "Link";action = "if (mcc_missionmaker == (name player)) then {nul=[5] execVM 'mcc\general_scripts\jukebox\jukebox.sqf';} else {player globalchat 'Access Denied'};";};
