...
class ExtrasDialog3 {
 ...
 class playersManagmentBackGround : gitaTextBackground {x=0.58; y=0.0725; w=0.15; h=0.16;};
 //========================================= Controls========================================
...
//Mobile Spawn
 ...
 //players
 class playersManagment : RscListBox {idc=MCC_PLAYERS; style=LB_MULTI; colorText[]={1,1,1,1}; colorSelect[]={1.0,0.35,0.3,1}; colorBackground[]={0,0,0,0.6};
									colorSelectBackground[]={0,0,0,1}; font="BitStream"; sizeEx=0.028; x=0.58; y=0.0725; w=0.15; h=0.16; rowHeight=0.022; autoScrollRewind=0;
									autoScrollDelay=0; autoScrollSpeed=0;};
...
//Unit managment
  class playersManagmentTittle : Zone_NumberTitle {x=0.56; y=0.03; colorText[]={0,1,1,1}; text="Units managment:";};
...
//Unit managment
  class UMTeleportButton : RscButton {idc=-1; x=0.75; y=0.07; w=0.1; h=0.03; size=0.02; sizeEx=0.03; text="Teleport"; onButtonClick = "if (mcc_missionmaker == (name player)) then {nul=[0] execVM 'mcc\general_scripts\unitManage\um.sqf';} else {player globalchat 'Access Denied'};";};
  class UMTeleportLHDButton : RscButton {idc=-1; x=0.75; y=0.11; w=0.1; h=0.03; size=0.02; sizeEx=0.03; text="Tel. 2 LHD"; onButtonClick = "if (mcc_missionmaker == (name player)) then {nul=[1] execVM 'mcc\general_scripts\unitManage\um.sqf';} else {player globalchat 'Access Denied'};";};
  class UMPlayerButton : RscButton {idc=-1; x=0.57; y=0.24; w=0.05; h=0.027; size=0.02; sizeEx=0.025; text="Players"; onButtonClick = "if (mcc_missionmaker == (name player)) then {nul=[0] execVM 'mcc\general_scripts\unitManage\side_change.sqf';} else {player globalchat 'Access Denied'};";};
  class UMEastButton : RscButton {idc=-1; x=0.62; y=0.24; w=0.05; h=0.027; size=0.02; sizeEx=0.025;colorText[] = {1,0,0,1}; text="East"; onButtonClick = "if (mcc_missionmaker == (name player)) then {nul=[1] execVM 'mcc\general_scripts\unitManage\side_change.sqf';} else {player globalchat 'Access Denied'};";};
  class UMWestButton : RscButton {idc=-1; x=0.67; y=0.24; w=0.05; h=0.027; size=0.02; sizeEx=0.025;colorText[] = {0,0,1,1}; text="West"; onButtonClick = "if (mcc_missionmaker == (name player)) then {nul=[2] execVM 'mcc\general_scripts\unitManage\side_change.sqf';} else {player globalchat 'Access Denied'};";};
  class UMGurButton : RscButton {idc=-1; x=0.72; y=0.24; w=0.05; h=0.027; size=0.02; sizeEx=0.025;colorText[] = {0,1,0,1}; text="GUR"; onButtonClick = "if (mcc_missionmaker == (name player)) then {nul=[3] execVM 'mcc\general_scripts\unitManage\side_change.sqf';} else {player globalchat 'Access Denied'};";};
   };
