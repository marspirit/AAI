...
class ExtrasDialog3 {
 ...
 //========================================= Background========================================
 class MCC_Title : RscText {x = 0.02; y = 0.01;w = 3; colorBackground[] = { 1, 1, 1, 0 };text = "MCC Sandbox V1.5.4 redone by Shay_gman";};
...
//Mobile Spawn
 ...
 class playersManagment : RscListBox {idc=MCC_PLAYERS; style=LB_MULTI; colorText[]={1,1,1,1}; colorSelect[]={1.0,0.35,0.3,1}; colorBackground[]={0,0,0,0.6};
									colorSelectBackground[]={0,0,0,1}; font="BitStream"; sizeEx=0.028; x=0.58; y=0.0725; w=0.25; h=0.16; rowHeight=0.022; autoScrollRewind=0;
									autoScrollDelay=0; autoScrollSpeed=; onLBSelChanged = "if (mcc_missionmaker == (name player)) then {nul=[4] execVM 'mcc\general_scripts\unitManage\um.sqf';} else {player globalchat 'Access Denied'};";};
...
//Unit managment
  class UMTeleportButton : RscButton {idc=-1; x=0.85; y=0.07; w=0.1; h=0.03; size=0.02; sizeEx=0.02; text="Teleport"; onButtonClick = "if (mcc_missionmaker == (name player)) then {nul=[0] execVM 'mcc\general_scripts\unitManage\um.sqf';} else {player globalchat 'Access Denied'};";};
