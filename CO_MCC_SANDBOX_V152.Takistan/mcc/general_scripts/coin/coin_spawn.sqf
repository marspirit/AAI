private ["_pos", "_coinVehicle", "_coinRadius", "_coinFunds", "_dummy", "_dummy","_Funds"];

_pos = _this select 0;
_coinVehicle = _this select 1;
_coinRadius = _this select 2;
...
_dummy addAction ["Deploy HQ", "mcc\general_scripts\coin\coin_exec.sqf", [_coinVehicle, _coinRadius, _coinFunds]];
