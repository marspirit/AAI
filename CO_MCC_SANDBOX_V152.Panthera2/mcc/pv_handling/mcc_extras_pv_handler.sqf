...
if (isServer) then
{
	...
	["mine_single", {[(_this select 0), (_this select 1), (_this select 2)] execvm  "mcc\general_scripts\traps\put_mine.sqf";}] call CBA_fnc_addEventHandler;
	...
	["coin", {[(_this select 0), (_this select 1), (_this select 2), (_this select 3)] execvm "mcc\general_scripts\coin\coin_spawn.sqf";}] call CBA_fnc_addEventHandler;
	["simpleSpawn", {[(_this select 0), (_this select 1), (_this select 2), (_this select 3), (_this select 4), (_this select 5)] execvm "mcc\pop_menu\simple_spawn.sqf";}] call CBA_fnc_addEventHandler;
};