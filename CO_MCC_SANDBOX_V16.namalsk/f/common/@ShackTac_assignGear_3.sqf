...
"_dmrifle", "_dmriflemag", "_aa", "_aamag", "_radio","_medkit","_csGLGrenade", "_csGrenade"];
...
switch (_side) do
	...
	// The block of code below identifies equipment for the east factions.
	   ...
	   case "east":
		{
		   _rifle = "ACE_AK104_Kobra";
		   _rifleGL = "ACE_AK103_GL_Kobra";
		   _rifleTL = "ACE_AK103_GL_Kobra";
		   _medicrifle = "ACE_AKMS";
		   ...
		   _sfrifle = "ACE_gr1";
		   _sfrifleGL = "ACE_AK103_GL_1P29";
		   _sfriflemag = "30Rnd_762x39_AK47";
	   ...
	   case "west":
		{
		   ...
		   _sfrifle = "ACE_UMP45_AIM_SD";
		   _sfrifleGL = "ACE_UMP45_AIM_SD";
		   _sfriflemag = "ACE_25Rnd_1143x23_S_UMP45";
...
switch (_typeofUnit) do
	{
		...
		// LOADOUT: SF TEAM LEADER
		   ...
		   case "sfl":
		   {
			  ...
			  {_unit addmagazine _GLmag} foreach [1,2,3,4];
			  {_unit addmagazine _csGLGrenade} foreach [1,2];
			  {_unit addmagazine _Grenade} foreach [1,2];
			  {_unit addmagazine _smokegrenade;} foreach [1,2];
			  {_unit addmagazine _bandage} foreach [1,2];
			  if (_side == "west") then 
				{
				 _unit addweapon "Mk13_EP1";
				 _success = [_unit, "Mk13_EP1"] call ACE_fnc_PutWeaponOnBack;
				};
			  if (_side == "east") then 
				{
			  ...
			  [_unit,_GLmag,7] spawn f_addMagToRuck;
			  [_unit,_csGLGrenade,2] spawn f_addMagToRuck;
			  [_unit,_smokered,1] spawn f_addMagToRuck;
			  [_unit,_smokegreen,1] spawn f_addMagToRuck;
		...
		// LOADOUT: SF Radioman
		   ...
		   case "sfg":
		   {
			  ...
			  {_unit addmagazine _Grenade} foreach [1];
			  {_unit addmagazine _smokegrenade;} foreach [1];
			  {_unit addmagazine _csGrenade;} foreach [1,2];
			  {_unit addmagazine _bandage} foreach [1,2];
			  ...
			  switch (_side) do
				{
					case "east":
					{
						...
						{_unit addmagazine _csGrenade;} foreach [1];
						{_unit addmagazine _grenade} foreach [1];
						{_unit addmagazine _smokegrenade;} foreach [1,2];
						_unit addweapon "NVGoggles"; 
						_unit addweapon "ACE_Map_Tools";
