...
artilleryTypeArray = [["HE 105mm","ARTY_Sh_105_HE"], ["HE 85mm","Sh_85_HE"], ["HE 40mm","G_40mm_HE"], ["WP","ARTY_Sh_105_WP"], ["Smoke","Smokeshell"], ["Flare","F_40mm_White"]];
...
CASBombs = ["JDAM","LGB", "CBU-97", "CBU-AP", "CBU-WP", "CBU-CS", "CBU-Mines", "Tactical Nuke"];
