...
//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------			
	...
	KRON_UPS_TEMPLATES = [];
	KRON_UPS_MG_WEAPONS = ["MG36","M249","M240","MK_48","PK","PKm","Pecheneg","M249 Para","M249 Para M145","M240G M145","M60","ACE_GMV_M249_1",
							"ACE_GMV_M249_2","ACE_M249_AIM","ACE_M249_PIP_ACOG","ACE_RPK","ACE_RPK74M","ACE_RPK74M_1P29","BAF_L110A1_Aim"];
