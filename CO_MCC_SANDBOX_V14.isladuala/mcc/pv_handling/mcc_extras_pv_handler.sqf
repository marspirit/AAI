...
if (isServer) then
{
	...
	["trap_cw_area", {[(_this select 0), (_this select 1), (_this select 2), (_this select 3), (_this select 4)] spawn trap_cw_area}] call CBA_fnc_addEventHandler;
	...
	["sb_bomber_area", {[(_this select 0), (_this select 1), (_this select 2), (_this select 3), (_this select 4)] spawn sb_bomber_area}] call CBA_fnc_addEventHandler;
