...
if (isServer) then
{
	["trap_rc_single", {[(_this select 0), (_this select 1), (_this select 2), (_this select 3), (_this select 4), (_this select 5), (_this select 6)] spawn trap_rc_single}] call CBA_fnc_addEventHandler;
	["trap_rc_area", {[(_this select 0), (_this select 1), (_this select 2), (_this select 3), (_this select 4), (_this select 5), (_this select 6)] spawn trap_rc_area}] call CBA_fnc_addEventHandler;
