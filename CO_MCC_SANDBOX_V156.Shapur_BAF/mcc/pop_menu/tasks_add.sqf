...
switch (_type) do
{
   ...
   {mcc_tasks select _stringDescription select 1 setSimpleTaskDestination _pos;
    ...
    case 2:
	{
	[-2, {_this setTaskState "SUCCEEDED";},_stringDescription] call CBA_fnc_globalExecute;
	sleep 2; 
	...
	case 3:
	{
	[-2, {_this setTaskState "FAILED";},_stringDescription] call CBA_fnc_globalExecute;
	sleep 2; 
	...
	case 4:
	{
	[-2, {_this setTaskState "CANCELED";},_stringDescription] call CBA_fnc_globalExecute;
	sleep 2; 
