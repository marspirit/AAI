...
//Units
	class UnitTitle : Zone_NumberTitle {x = 0.45-0.1;y = 0.23;colorText[] = {0,1,1,1};text = "Unit:";};
		...
		class UnitSpawn3d : GroupSpawn {idc = -1;colorDisabled[] = {1, 0.4, 0.3, 0.8};x = 0.88;y = 0.22;w = 0.12; h = 0.08;size = 0.03;sizeEx = 0.04;text = "3D Editor";onButtonClick = "if (mcc_missionmaker == (name player)) then {[0] execVM 'mcc\pop_menu\spawn_group3d.sqf'} else {player globalchat 'Access Denied'};";};
