...
//--------------------------------------------------Support-------------------------------------------------------------
_comboBox = _mccdialog displayCtrl SUPPORT_PARATROOPS;		//fill combobox CFG Paratroops
	lbClear _comboBox;
	{
		_displayname = format ["%1",_x select 0];
		_comboBox lbAdd _displayname;
	} foreach paratroopsArray;
	_comboBox lbSetCurSel 0;
	
_comboBox = _mccdialog displayCtrl SUPPORT_ARTYSITE;		//fill combobox CFG Arty Site
	lbClear _comboBox;
	{
		_displayname = format ["%1",_x select 0];
		_comboBox lbAdd _displayname;
	} foreach artySiteArray;
	_comboBox lbSetCurSel 0;
