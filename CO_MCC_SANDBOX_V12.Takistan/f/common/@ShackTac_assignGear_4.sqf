...
"_oldrifle","_oldmag",
"_ruckmags","_ruckweapons","_sfrifle","_sfrifleGL","_sfriflemag","_sfsnrifle","_sfsnmag","_sfmg","_sfmgmag","_sfpistol","_sfpistolmag","_sfrifleGLmag", "_dmrifle", "_dmriflemag", "_aa", "_aamag", "_radio"];
...
//   _rifleGL = "ACE_SOC_M4A1_GL_Aim";
   ...
   _sfrifle = "SCAR_L_CQC_CCO_SD";
   _sfrifleGL = "SCAR_L_STD_EGLM_TWS";
   _sfriflemag = "30Rnd_556x45_StanagSD";
   _sfsnrifle = "M110_TWS_EP1";
   _sfsnmag = "20Rnd_762x51_B_SCAR";
   _sfmg = "M249_TWS_EP1";
   _sfmgmag = "200Rnd_556x45_M249";
   _sfpistol = "UZI_SD_EP1";
   _sfpistolmag = "30Rnd_9x19_UZI_SD";
   ...
   case "aar":
   {
      	...
      	case "bis_tk":
	{
      	...
      	case "bis_us":
   	{
	      ...
	      [_unit,_MGmag,4] spawn f_addMagToRuck;
	      [_unit,_smokegrenade,1] spawn f_addMagToRuck;
	      [_unit,_grenade,1] spawn f_addMagToRuck;
...
// LOADOUT: SF MG
   ...
   case "sfhg":
   {
	 ...
	 // {_unit addmagazine "8Rnd_B_Beneli_74Slug";} foreach [1,2,3];
	 // _unit addweapon "M1014";
	 // _success = [_unit, "M1014"] call ACE_fnc_PutWeaponOnBack;
