...
private ["_point1", "_point2", "_point3","_convoy_wp1","_convoy_wp2","_convoy_wp3","_flyInHight"];
...
if !mcc_isloading then 
	...
	hint "Markers placed";
	["evac_move", [[_point1, _point2, _point3], _flyInHight, true]] call CBA_fnc_globalEvent;
	}	
